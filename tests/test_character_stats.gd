...
func _test_clamping(t) -> void:
	...
	t.eq(CharacterStats.KIND_ORDER.size(), 8, "sekiz temel stat var (Faz 17: Bilgelik + İnanç)")
...
func _test_dict_round_trip(t) -> void:
	...
	t.eq(defaulted.wisdom, CharacterStats.BASE_VALUE, "Faz 17 öncesi kayıtta Bilgelik tabana düşer")
	t.eq(defaulted.faith, CharacterStats.BASE_VALUE, "Faz 17 öncesi kayıtta İnanç tabana düşer")
