    ...
    f += [
        ...
        table(
            ...
            [
                ...
                ["İnsan / mizaç", "7", "Yolcu · Kaçak · Oba · Hacı · <i>üç zincir kartı</i>"],
                ...
                ["<b>Bu tabloda</b>", "<b>29</b>", "bunların 3'ü yalnızca zincirle açılır"],
            ],
        ...
        sp(2),
        para(
            "Bu tablo havuzun tamamı değil, elle tutulan bir alt küme - canlı kod tabanındaki "
            "<tt>EventCatalog.get_road_events()</tt> bugün 41 kart döndürüyor (dünya olayı "
            "haberleri, soruşturma zinciri, toplama/av gibi birkaç fazdır eklenmiş kart daha). "
            "Her yeni kart bu dosyaya elle işlenmedikçe (bkz. <tt>docs/codex/README.md</tt>) "
            "sayı gerçek kataloğun gerisinde kalır - kayıtlı, kapatılmamış bir iş.",
            "small",
        ),
    ]
    return f
    ...
    return [
        ...
        table(
            ...
            [
                ...
                ["Olay kartı", "41 canlı, 29'u bu ekte belgeli (3'ü zincir)"],
                ["Etki sözlüğü", "26 tip"],
