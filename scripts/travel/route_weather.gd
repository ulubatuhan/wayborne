...
static func forecast_extra_days(
	...
	while walked < float(days) and spent < days * 6 + 12:
		...
		if terrain != null:
			...
			# Faz 17 PR-6: eğim artık kondisyon ve havayla aynı günlük
			# yürüyüşün içinde çarpılıyor - ayrı ayrı hesaplayıp toplamak
			# bileşik yavaşlamayı hafife alırdı, tıpkı condition_factor'ün
