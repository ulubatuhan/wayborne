...
##
## Ödül ekonomik değil, bilgi: mizacın kendisi, Sezgi eşiğiyle okunabildiği
## kadarıyla (bkz. GameSession.get_merchant_disposition_label) - o yüzden
## `WagonPanel`'in aksine burada yazılabilecek bir envanter yok, salt
